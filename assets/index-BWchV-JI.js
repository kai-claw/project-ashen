...
#define LOW_PRECISION`),t}const v0={[sa]:"SHADOWMAP_TYPE_PCF",[rs]:"SHADOWMAP_TYPE_VSM"};function M0(s){return v0[s.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const y0={[fi]:"ENVMAP_TYPE_CUBE",[zi]:"ENVMAP_TYPE_CUBE",[va]:"ENVMAP_TYPE_CUBE_UV"};function S0(s){return s.envMap===!1?"ENVMAP_TYPE_CUBE":y0[s.envMapMode]||"ENVMAP_TYPE_CUBE"}const w0={[zi]:"ENVMAP_MODE_REFRACTION"};function b0(s){return s.envMap===!1?"ENVMAP_MODE_REFLECTION":w0[s.envMapMode]||"ENVMAP_MODE_REFLECTION"}const T0={[Yc]:"ENVMAP_BLENDING_MULTIPLY",[xh]:"ENVMAP_BLENDING_MIX",[vh]:"ENVMAP_BLENDING_ADD"};function E0(s){return s.envMap===!1?"ENVMAP_BLENDING_NONE":T0[s.combine]||"ENVMAP_BLENDING_NONE"}function A0(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function C0(s,t,e,n){const i=s.getContext(),a=e.defines;let r=e.vertexShader,o=e.fragmentShader;const c=M0(e),l=S0(e),h=b0(e),u=E0(e),d=A0(e),f=u0(e),g=d0(a),M=i.createProgram();let m,p,_=e.glslVersion?"#version "+e.glslVersion+`
