...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function Sc(){return new Pe({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:yr(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function yc(){return new Pe({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yr(),fragmentShader:`
